...
class AcronymsWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.tab_widget.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)  # Add this line
        ...
        self.add_row_button_likely.clicked.connect(lambda: self.add_new_row(self.likely_table))
        ...
        self.add_row_button_possible.clicked.connect(lambda: self.add_new_row(self.possible_table))
        ...
        self.add_row_button_unlikely.clicked.connect(lambda: self.add_new_row(self.unlikely_table))
        ...
        self.likely_table.setColumnWidth(0, 100)  # Adjust the width as needed
        self.likely_table.setColumnWidth(1, 150)  # Adjust the width as needed
        self.likely_table.setColumnWidth(2, 60)   # Adjust the width as needed
        self.likely_table.setColumnWidth(3, 400)  # Adjust the width as needed

        self.possible_table.setColumnWidth(0, 100)  # Adjust the width as needed
        self.possible_table.setColumnWidth(1, 150)  # Adjust the width as needed
        self.possible_table.setColumnWidth(2, 60)   # Adjust the width as needed
        self.possible_table.setColumnWidth(3, 400)  # Adjust the width as needed

        self.unlikely_table.setColumnWidth(0, 100)  # Adjust the width as needed
        self.unlikely_table.setColumnWidth(1, 150)  # Adjust the width as needed
        self.unlikely_table.setColumnWidth(2, 60)   # Adjust the width as needed
        self.unlikely_table.setColumnWidth(3, 400)  # Adjust the width as needed


        # Inside the __init__ method after creating the tables
        self.likely_check_all_button = QPushButton('Likely: Check/Uncheck All', self)
        self.likely_check_all_button.setStyleSheet('QPushButton {color: #5E2D91; font-weight: bold;}')
        ...
        self.possible_check_all_button = QPushButton('Possible: Check/Uncheck All', self)
        self.possible_check_all_button.setStyleSheet('QPushButton {color: #5E2D91; font-weight: bold;}')
        ...
        self.unlikely_check_all_button = QPushButton('Unlikely: Check/Uncheck All', self)
        self.unlikely_check_all_button.setStyleSheet('QPushButton {color: #5E2D91; font-weight: bold;}')
    ...
    def create_table(self):
        ...
        table.setHorizontalHeaderLabels(["Acronym", "Likely Definition", "Include", "Context"])
        table.setMinimumHeight(300) # Adjust this value based on your requirements
        table.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding) # Add this line
        return table
    ...
    def run_macro(self):
        try:
            ...
            dir_path = os.path.dirname(os.path.realpath(__file__))
            definition_path = os.path.join(dir_path, '..', 'acronyms', 'acronym list.txt')
    ...
    def generate_table(self):
        try:
            ...
            if file_path:
                ...
                rows = []
                for acronym_table in [self.likely_table, self.possible_table, self.unlikely_table]:
                    for i in range(acronym_table.rowCount()):
                        ...
                        if checkbox.isChecked():
                            rows.append((acronym_item.text(), definition_item.text()))
    ...
    def check_uncheck_all(self, table):
        ...
        for i in range(table.rowCount()):
            ...
            # On the first iteration, decide whether to check or uncheck all boxes
